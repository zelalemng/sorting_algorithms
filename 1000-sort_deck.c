 ...
 *
 * Return: Positive byte diffrence if S1 > S2
 *         0 is S1 == S2
 ...
 * spades to diamonds from from ace to king.
 * @deck: a pointer to the head of a deck_node_t doubly-linked list.
 */
void insertion_sort_deck_value(deck_node_t **deck)
{
...
/**
 * sort_deck - Sort a deck of a cards from ace to king and
 * from spades to diamonds.
 * @deck: A pointer to the head of a deck of deck_node_t doubly-linked list.
 */
void sort_deck(deck_node_t **deck)
{
